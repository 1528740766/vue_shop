<template>
    <div>
            ...
            <el-table :data="userlist" border stripe>
                ...
                <el-table-column label="状态">
                    <template slot-scope="scope">
                        <el-switch v-model="scope.row.mg_state" @change="userStateChanged(scope.row.id)">
                        </el-switch>
                    </template>
                </el-table-column>
        ...
        <!-- 修改用户的对话框 -->
        <el-dialog title="修改用户" :visible.sync="eidetDialogVisible" width="50%" @click="editDialogClosed">
